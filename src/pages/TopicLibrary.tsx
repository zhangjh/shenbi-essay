...
const TopicLibrary = () => {
  ...
  useEffect(() => {
    // 设置页面标题和SEO
    document.title = '作文题目库 - 神笔作文';
    
    // 添加meta描述
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', '海量优质作文题目库，涵盖小学、初中、高中各年级，包含记叙文、议论文、说明文等多种类型，助力学生提升写作能力。');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = '海量优质作文题目库，涵盖小学、初中、高中各年级，包含记叙文、议论文、说明文等多种类型，助力学生提升写作能力。';
    ...
    if (metaKeywords) {
      metaKeywords.setAttribute('content', '作文题目,作文题库,小学作文,初中作文,高中作文,记叙文,议论文,说明文,写作练习');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'keywords';
      meta.content = '作文题目,作文题库,小学作文,初中作文,高中作文,记叙文,议论文,说明文,写作练习';
      document.head.appendChild(meta);
    }
  }, []);
